...
#
# Script generated by Vivado on Wed Apr 23 20:48:24 +0800 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : DATA_Bank_RAM.sh
...
#
# Usage        : DATA_Bank_RAM.sh
#                DATA_Bank_RAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DATA_Bank_RAM.sh [-reset_run]
#                DATA_Bank_RAM.sh [-reset_log]
#                DATA_Bank_RAM.sh [-help]
#
...
# script info
echo -e "DATA_Bank_RAM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DATA_Bank_RAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DATA_Bank_RAM xil_defaultlib.DATA_Bank_RAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DATA_Bank_RAM -key {Behavioral:sim_1:Functional:DATA_Bank_RAM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DATA_Bank_RAM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DATA_Bank_RAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DATA_Bank_RAM.sh [-help]\n\
Usage: DATA_Bank_RAM.sh [-step]\n\
Usage: DATA_Bank_RAM.sh [-lib_map_path]\n\
Usage: DATA_Bank_RAM.sh [-reset_run]\n\
Usage: DATA_Bank_RAM.sh [-reset_log]\n\
Usage: DATA_Bank_RAM.sh [-keep_index]\n\
Usage: DATA_Bank_RAM.sh [-noclean_files]\n\n\
