...
#
# Script generated by Vivado on Wed Apr 16 14:47:01 +0800 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : my_div_s.sh
...
#
# Usage        : my_div_s.sh
#                my_div_s.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                my_div_s.sh [-reset_run]
#                my_div_s.sh [-reset_log]
#                my_div_s.sh [-help]
#
...
#                script (type 'my_div_s.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname xbip_pipe_v3_0_6 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname floating_point_v7_0_20 -libname xbip_dsp48_mult_v3_0_6 -libname xbip_dsp48_multadd_v3_0_6 -libname div_gen_v5_1_19 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 floating_point_v7_0_20 xbip_dsp48_mult_v3_0_6 xbip_dsp48_multadd_v3_0_6 div_gen_v5_1_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "my_div_s.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./my_div_s.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../loongson.gen/sources_1/ip/my_div_s/sim/my_div_s.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.my_div_s xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.my_div_s -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log my_div_s_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./my_div_s.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: my_div_s.sh [-help]\n\
Usage: my_div_s.sh [-step]\n\
Usage: my_div_s.sh [-lib_map_path]\n\
Usage: my_div_s.sh [-reset_run]\n\
Usage: my_div_s.sh [-reset_log]\n\
Usage: my_div_s.sh [-keep_index]\n\
Usage: my_div_s.sh [-noclean_files]\n\n\
