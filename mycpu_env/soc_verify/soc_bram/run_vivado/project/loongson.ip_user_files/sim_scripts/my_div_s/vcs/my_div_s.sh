...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.my_div_s xil_defaultlib.glbl -o my_div_s_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./my_div_s_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key my_div_s_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc my_div_s_simv.daidir vcs_lib c.obj)
