...
design_libs=(xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 floating_point_v7_0_20 xbip_dsp48_mult_v3_0_6 xbip_dsp48_multadd_v3_0_6 div_gen_v5_1_19 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.my_div_u xil_defaultlib.glbl -o my_div_u_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./my_div_u_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key my_div_u_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc my_div_u_simv.daidir vcs_lib c.obj)
