...
#
# Script generated by Vivado on Wed Apr 16 14:47:40 +0800 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : my_div_u.sh
...
#
# Usage        : my_div_u.sh
#                my_div_u.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                my_div_u.sh [-reset_run]
#                my_div_u.sh [-reset_log]
#                my_div_u.sh [-help]
#
...
#                script (type 'my_div_u.sh -help' for more information).
#
...
# script info
echo -e "my_div_u.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./my_div_u.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../loongson.gen/sources_1/ip/my_div_u/sim/my_div_u.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.my_div_u xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.my_div_u -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log my_div_u_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./my_div_u.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: my_div_u.sh [-help]\n\
Usage: my_div_u.sh [-step]\n\
Usage: my_div_u.sh [-lib_map_path]\n\
Usage: my_div_u.sh [-reset_run]\n\
Usage: my_div_u.sh [-reset_log]\n\
Usage: my_div_u.sh [-keep_index]\n\
Usage: my_div_u.sh [-noclean_files]\n\n\
