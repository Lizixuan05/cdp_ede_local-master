...
#
# Script generated by Vivado on Wed Apr 23 20:49:13 +0800 2025
...
#
# Usage        : TAG_RAM.sh
#                TAG_RAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TAG_RAM.sh [-reset_run]
#                TAG_RAM.sh [-reset_log]
#                TAG_RAM.sh [-help]
#
...
# script info
echo -e "TAG_RAM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TAG_RAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TAG_RAM xil_defaultlib.TAG_RAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TAG_RAM -key {Behavioral:sim_1:Functional:TAG_RAM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TAG_RAM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TAG_RAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TAG_RAM.sh [-help]\n\
Usage: TAG_RAM.sh [-step]\n\
Usage: TAG_RAM.sh [-lib_map_path]\n\
Usage: TAG_RAM.sh [-reset_run]\n\
Usage: TAG_RAM.sh [-reset_log]\n\
Usage: TAG_RAM.sh [-keep_index]\n\
Usage: TAG_RAM.sh [-noclean_files]\n\n\
