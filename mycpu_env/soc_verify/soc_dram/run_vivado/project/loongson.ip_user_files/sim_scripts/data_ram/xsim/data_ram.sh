...
#
# Script generated by Vivado on Mon Mar 31 22:11:53 +0800 2025
...
# script info
echo -e "data_ram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_ram xil_defaultlib.data_ram xil_defaultlib.glbl -log elaborate.log
}
