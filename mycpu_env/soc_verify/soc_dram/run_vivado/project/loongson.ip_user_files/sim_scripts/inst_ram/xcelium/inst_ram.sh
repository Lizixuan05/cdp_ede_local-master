...
design_libs_elab="-libname xpm -libname dist_mem_gen_v8_0_13 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"
...
compile()
{
  ...
  xmvlog -work dist_mem_gen_v8_0_13 $xmvlog_opts \
